...
class AddChatMembersWidget extends StatefulWidget {
  const AddChatMembersWidget({
    Key key,
    this.chat,
  }) : super(key: key);
  ...
  @override
  _AddChatMembersWidgetState createState() => _AddChatMembersWidgetState();
}

class _AddChatMembersWidgetState extends State<AddChatMembersWidget> {
